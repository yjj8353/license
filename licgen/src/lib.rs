...
mod tests {
    ...
    fn make_inputs(private_key: &str) -> Inputs {
        Inputs {
            ...
            system_uuid: CString::new("system-uuid-1234").unwrap(),
            machine_id: CString::new("machine-id-5678").unwrap(),
            mac_address: CString::new("00:11:22:33:44:55").unwrap(),
    ...
    unsafe fn call_license_generate(inputs: &Inputs, out_buf: *mut c_char, out_len: usize, out_written: *mut usize) -> i32 {
        unsafe {
            license_generate(
                ...
                inputs.system_uuid.as_ptr(),
                inputs.machine_id.as_ptr(),
                inputs.mac_address.as_ptr(),
